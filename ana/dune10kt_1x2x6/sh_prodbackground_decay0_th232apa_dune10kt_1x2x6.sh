...
export gen=prodbackground_decay0_th232apa

#--------------------------------------#

export evgenfcl=$pathLarSoft/srcs/dunesw/fcl/dunefd/gen/solar/${gen}_${det}.fcl
export G4fcl=$pathLarSoft/srcs/dunesw/fcl/dunefd/g4/standard_g4_${det}.fcl
export detsimfcl=$pathLarSoft/srcs/dunesw/fcl/dunefd/detsim/supernova_detsim_${det}.fcl
