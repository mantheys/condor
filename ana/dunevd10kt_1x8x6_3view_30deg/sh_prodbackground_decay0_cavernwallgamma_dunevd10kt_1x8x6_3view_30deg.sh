...
export gen=prodbackground_decay0_cavernwallgamma

#--------------------------------------#

export evgenfcl=$pathLarSoft/srcs/dunesw/fcl/dunefdvd/gen/solar/${gen}_${det}.fcl
export G4fcl=$pathLarSoft/srcs/dunesw/fcl/dunefdvd/g4/solar_g4_${det}.fcl
export detsimfcl=$pathLarSoft/srcs/dunesw/fcl/dunefdvd/detsim/standard_detsim_${det}.fcl
export recofcl=$pathLarSoft/srcs/dunesw/fcl/dunefdvd/reco/standard_reco_${det}.fcl
